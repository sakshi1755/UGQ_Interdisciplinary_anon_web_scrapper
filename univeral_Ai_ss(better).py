...
class UniversalScraper:
    ...
    # #
    # Html snapshot for listing pages grabs repeating elements
    # #
    ...
    # #
    # Html snapshot for detail pages focuses on comments body
    # #
    ...
    # #
    # Phase 1 gemini discovers listing page structure
    # #
...
"""
    ...
    # #
    # Phase 2 gemini discovers post detail page structure
    # #
...
"""
    ...
    # #
    # Extract posts from listing using phase 1 blueprint
    # #
    ...
    # #
    # Phase 2 visit first post, screenshot it, ask gemini for detail selectors
    # #
    ...
    # #
    # Enrich all posts using phase 2 blueprint
    # #
    ...
    def start(self, url: str, enrich: bool = True):
        ...
        with sync_playwright() as p:
            # Use a temp copy of your chrome profile so chrome doesn't need to be closed
            ...
            # Only copy cookies local storage fast and enough for login
            os.makedirs(tmp_profile, exist_ok=True)
            for f_name in ["Cookies", "Local Storage", "Session Storage", "Preferences"]:
                src = os.path.join(real_profile, f_name)
                dst = os.path.join(tmp_profile, f_name)
            ...
            # Enrich posts with body comments
